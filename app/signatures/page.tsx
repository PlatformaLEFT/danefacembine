  ...
  return (
    <main className="max-w-screen-xl mx-auto p-3 mb-10">
      <h2 className="text-4xl font-black py-8">
        Nu ai cu cine vota?
        <br /> Află că societatea se trezește și se implică.
      </h2>
      <div className="flex lg:flex-row flex-col-reverse justify-between gap-4 relative">
        <p className="text-xl lg:w-3/5 lg:border-r-2 lg:border-b-0 border-b-2 border-[#532f7f] lg:pr-8">
          ...
          venite din rândul oamenilor. Momentul alegerilor a venit, iar
          sindicaliștii și ONG-iștii independenți, alături de cetățeni și-au
          unit eforturile cu un partid tânăr, pan-european,{" "}
          <Link
          ...
          asigurarea unui trai decent, tratament egal pentru toți cetățenii UE,
          o pensie minimă, un salariu minim și indemnizații minime la nivelul
          Uniunii. Vrem să eliminăm deciziile proaste luate de Comisie, de
          exemplu renunțarea la liberalizarea pieței de energie și reanalizarea
          ...
          acorde subvențiile necesare producției și funcționării fermelor. Vrem
          un Green Deal realist, care să protejeze natura și oamenii.
          <br /> <br />
          ...
          punem sub control cetățenesc. Vrem transparență totală și vrem ca
          toate documentele instituțiilor să fie afișate obligatoriu pe
          siteurile acestora. Vrem ca cetățenii să poată participa la luarea
        ...
        <div className="lg:sticky top-0 flex lg:flex-col sm:flex-row flex-col lg:justify-start justify-between gap-10 py-4 h-fit lg:w-2/5">
          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            <Link href="/signatures/euro">
              <button className="inline-flex items-center justify-center rounded-md px-4 py-4 lg:text-4xl text-xl w-full font-semibold shadow-sm bg-[#532f7f] text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white hover:outline outline-2 outline-black ml-1 uppercase">
                Semnează pentru europarlamentare!
              </button>
            </Link>
          </div>
        </div>
